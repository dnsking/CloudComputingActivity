...
namespace CloudComputingActivity.Cloud_Storage.Dropbox
{
    public class Download : CodeActivity
    {
        [Category("Output")]
        ...
        protected override void Execute(CodeActivityContext context)
        {
            try
            {
                ...
                var mUniversalDataHandler = new DropboxDataHandler();

                mUniversalDataHandler.Download(Generate(SourcePath.Get(context),null)
