...
{
    public class CreateTable : CodeActivity
    {
        [Category("Input")]
        ...
        [Category("Input (use ';' to separate multiple)")]
        [DisplayName("Columns Types")]
        [RequiredArgument]
        public InArgument<string> ColumnsTypes { get; set; }
        [Category("Input")]
        [DisplayName("Port")]
        [RequiredArgument]
        ...
        protected override void Execute(CodeActivityContext context)
        {
            try
            {
              ...
              var value=  cmd.CreateTableAutoID(Table.Get(context), Columns.Get(context).Split(';'), ColumnsTypes.Get(context).Split(';')); ;
