...
namespace CloudComputingActivity.Databases.Azure
{
    public class CreateTable : CodeActivity
    {
        ...
        [Category("Input")]
        [DisplayName("Columns Types (use ';' to separate multiple)")]
        [RequiredArgument]
        ...
        protected override void Execute(CodeActivityContext context)
        {
            try
            {
              ...
              var value=  azureSqlConnector.CreateTableAutoID(Table.Get(context), Columns.Get(context).Split(';'), ColumnsTypes.Get(context).Split(';')); ;
